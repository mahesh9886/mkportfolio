! function (s, f, c) {
    ...
    function i(e) {
        ...
        E && (n = n.baseVal), _._config.enableJSClass && (t = new RegExp("(^|\\s)" + o + "no-js(\\s|$)"), n = n.replace(t, "$1" + o + "js$2")), _._config.enableClasses && (n += " " + o + e.join(" " + o), E ? T.className.baseVal = n : T.className = n)
    }
    ...
    function a(e, t) {
        if ("object" == typeof e)
            ...
            var o = (e = e.toLowerCase()).split("."),
                r = _[o[0]];
            if (void 0 !== (r = 2 == o.length ? r[o[1]] : r)) return _;
            t = "function" == typeof t ? t() : t, 1 == o.length ? _[o[0]] = t : (!_[o[0]] || _[o[0]] instanceof Boolean || (_[o[0]] = new Boolean(_[o[0]])), _[o[0]][o[1]] = t), i([(t && 0 != t ? "" : "no-") + o.join("-")]), _._trigger(e, t)
        }
        return _
    }
    ...
    function R(e, t) {
        ...
        if ("CSS" in s && "supports" in s.CSS) {
            for (; n--;)
                if (s.CSS.supports(l(e[n]), t)) return !0;
            return !1
        }
    ...
    function o(e, t, n, o, r) {
        var s, i, a = e.charAt(0).toUpperCase() + e.slice(1),
            l = (e + " " + G.join(a + " ") + a).split(" ");
        if (m(t, "string") || void 0 === t) return h(l, t, o, r);
    ...
    var u, d, A, t, e, g, v, y, C, b, w, S = [],
        ...
        k = (_._q.unshift(function () {
            ...
            for (var e = !1, t = P.length, e = _.hasEvent("pointerdown"); t-- && !e;) q(P[t] + "pointerdown") && (e = !0);
            return e
    ...
    _.addTest("websockets", k), _.addTest("cssanimations", n("animationName", "a", !0)), _.addTest("csscolumns", function () {
        var e = !1,
            t = n("columnCount");
        try {
            e = (e = !!t) && new Boolean(e)
    ...
    for (var z, O, L = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], N = 0; N < L.length; N++) z = L[N].toLowerCase(), O = n("column" + L[N]), "breakbefore" !== z && "breakafter" !== z && "breakinside" != z || (O = O || n(L[N])), _.addTest("csscolumns." + z, O);
    for (w in _.addTest("flexbox", n("flexBasis", "1px", !0)), _.addTest("picture", "HTMLPictureElement" in s), _.addAsyncTest(function () {
        ...
        if (S.hasOwnProperty(w)) {
            if (e = [], (g = S[w]).name && (e.push(g.name.toLowerCase()), g.options && g.options.aliases && g.options.aliases.length))
                for (v = 0; v < g.options.aliases.length; v++) e.push(g.options.aliases[v].toLowerCase());
            for (y = m(g.fn, "function") ? g.fn() : g.fn, C = 0; C < e.length; C++) 1 === (b = e[C].split(".")).length ? _[b[0]] = y : (!_[b[0]] || _[b[0]] instanceof Boolean || (_[b[0]] = new Boolean(_[b[0]])), _[b[0]][b[1]] = y), M.push((y ? "" : "no-") + b.join("-"))
        } i(M), delete x.addTest, delete x.addAsyncTest;
    for (var j = 0; j < _._q.length; j++) _._q[j]();
    s.Modernizr = _
}(window, document);