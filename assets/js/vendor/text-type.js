jQuery(document).ready(function (d) {
    ...
    function f(s) {
        ...
        }(s.find("i").eq(0), s, e, r), m(a.find("i").eq(0), a, e, r)) : s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({
            width: "2px"
        }, p, function () {
            v(s, a), C(a)
        }) : s.parents(".cd-headline").hasClass("loading-bar") ? (s.parents(".cd-words-wrapper").removeClass("is-loading"), v(s, a), setTimeout(function () {
            f(a)
        }, n), setTimeout(function () {
            s.parents(".cd-words-wrapper").addClass("is-loading")
        }, t)) : (v(s, a), setTimeout(function () {
            f(a)
        }, l))
    }
    ...
    s.each(function () {
        var s, i, e, a = d(this);
        a.hasClass("loading-bar") ? (u = n, setTimeout(function () {
            a.find(".cd-words-wrapper").addClass("is-loading")
        }, t)) : a.hasClass("clip") ? (s = (i = a.find(".cd-words-wrapper")).width() + 10, i.css("width", s)) : a.hasClass("type") || (i = a.find(".cd-words-wrapper b"), e = 0, i.each(function () {
            var s = d(this).width();
            e < s && (e = s)
